...
fun ListPersonsScreen (
    // vm : ListPersonsViewModel = androidx.hilt.navigation.compose.hiltViewModel(),
    navigator: DestinationsNavigator
) {
    /*val uiState by fr.uha.wetterwald.summercamp.ui.person.ListPersonsViewModel.uiState.collectAsStateWithLifecycle()

    androidx.compose.material3.Scaffold (
        topBar = { fr.uha.hassenforder.android.ui.app.AppTopBar(fr.uha.hassenforder.android.ui.app.UITitleState(fr.uha.hassenforder.android.ui.app.UITitleState.screenNameId = R.string.list_person)) },
