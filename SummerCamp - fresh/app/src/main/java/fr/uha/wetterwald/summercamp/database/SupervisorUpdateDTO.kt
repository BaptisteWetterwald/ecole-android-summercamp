...
sealed class SupervisorUpdateDTO {
    ...
    data class Gender(
        ...
        val gender: fr.uha.wetterwald.summercamp.model.Gender
    ) : SupervisorUpdateDTO()
    ...
    data class Specialties(
        val supervisorId: Long,
        val specialties: List<ActivityUpdateDTO.Specialty>
    ) : SupervisorUpdateDTO()

    data class Availability(val supervisorId: Long, val availability: String) :
        SupervisorUpdateDTO()
}