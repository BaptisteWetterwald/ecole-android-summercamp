...
@Composable
fun OutlinedSpecialtyFieldWrapper(
    field: FieldWrapper<Specialty>,
    onValueChange: ((Specialty) -> Unit)?,
    ...
    OutlinedDecorator(
        ...
        Row(
            ...
            Text(
                text = field.value?.name ?: stringResource(id = R.string.choose_specialty),
